...
!Solving complex matrix using LAPACK
!taken from
!http://sites.science.oregonstate.edu/~landaur/nacphy/lapack/fortran.html
!
!ONLY EIGENVALUES NO EIGENVECTORS
!EIGENVECTORS ==> right eigenvectors
!There is also the left eigenvectors.
...
!c    no left eigenvectors, no right eigenvectors, order of input matrix
!A,
